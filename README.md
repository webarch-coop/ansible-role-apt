...
This role has been automatically tested using [GitLab CI](.gitlab-ci.yml) and [Molecule](molecule/default/molecule.yml) on Debian Forky, Trixie and Bookworm and Ubuntu Noble and Resolute.
